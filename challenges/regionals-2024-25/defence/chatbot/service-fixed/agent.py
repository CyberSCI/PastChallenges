...
def update_candidate_platform(candidate: str, platform: str, config: RunnableConfig) -> str:
    ...
    print(f"User {config.get('configurable', {}).get('username')} attempting to access information for user {candidate}")
...
def get_user_info(username: str, config: RunnableConfig) -> str:
    ...
    print(f"User {config.get('configurable', {}).get('username')} attempting to access information for user {username}")
