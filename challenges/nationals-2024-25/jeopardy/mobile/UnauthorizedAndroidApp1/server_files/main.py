...
API_DEV_TOKEN = "gGBCZ2UmgQru0xd0Xe1Xp2eve" # SECURITY 101 - A single hard-coded DEV TOKEN is simpler
SECRET_KEY = "2UmgQru0xd0Xe1Xp2gGBCZev3"
...
app = FastAPI(
    title="Valverde Electoral Commission Mobile Vote DEV SERVER",
    docs_url="/docs",
    description="Please use this API_DEV_TOKEN for development purposes : gGBCZ2UmgQru0xd0Xe1Xp2eve"
)

valid_users = {
    "dev1": "zmtIjJNOdho83oYaMK",
    "dev2": "836GcE5cDBe6X5ilTg"
}
...
user_infos = {
    "dev1": UserInfo("8ZT5513", 2002, "AZ900231433"),
    "dev2": UserInfo("AZI0200", 1990, "AZ900100025")
}
...
@app.post("/votar")
def votar(token: str = Form(...), candidate_id: str = Form(...)):
    ...
    try:
        ...
        return {"success":True, "vote_confirmation_number": "VALVERDE_A4E5610B2AE"}
    except JWTError:
